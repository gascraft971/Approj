<div class="post card">
	<div class="card-body">
		...
		<div class="container p-0 post-title">
			<a href="{{ route("posts.show", [$post->slug]) }}" class="text-decoration-none me-2" style="display: inline-block">
		...
		<p class="card-text">
		<?php
		$content = codex2html(json_decode($post->content, true)["blocks"]);
		...
		?>
		<br/>
		<a href="{{ route("posts.show", [$post->slug]) }}" class="text-decoration-none">Read more</a>
		</p>
	</div>
</div>